...
##%global snap 2d24b6000d5611615e3e6d799e20d5fdbe4e2a1e
...
#%if 0%{?snap:1}
# Snapshots taken from github master. commit hash 2d24b6000d5611615e3e6d799e20d5fdbe4e2a1e
#unzip openjpeg-master.zip
#mv openjpeg-master openjpeg-2.1.0
#tar cvf openjpeg-2.1.0.tar.gz openjpeg-2.1.0
...
#     mv $file ${file/opj_/opj_}
# done
#mv %{buildroot}%{_mandir}/man1/opj_compress.1 %{buildroot}%{_mandir}/man1/opj_compress.1
#mv %{buildroot}%{_mandir}/man1/opj_decompress.1 %{buildroot}%{_mandir}/man1/opj_decompress.1
#mv %{buildroot}%{_mandir}/man1/opj_dump.1 %{buildroot}%{_mandir}/man1/opj_dump.1
...
%changelog
* Fri Apr 24 2015 Rashad Kanavath <rashad.kanavath@c-s.fr> - 2.1.0-4
- copied spec and patches from cgit
- http://pkgs.fedoraproject.org/cgit/openjpeg.git/
- update to 2.1.0 commit 2d24b6000d5611615e3e6d799e20d5fdbe4e2a1e
