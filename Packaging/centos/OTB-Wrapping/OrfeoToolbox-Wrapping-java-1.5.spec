...
Group:          Development/Libraries
License:        Cecill
Requires:       jdk >= 1.5.0 OrfeoToolbox = 3.10.0
...
cmake -DBUILD_TESTING:BOOL=OFF \
      ...
      -DJAVA_ARCHIVE:FILEPATH=/usr/java/jdk1.5.0_22/bin/jar \
      -DJAVA_COMPILE:FILEPATH=/usr/java/jdk1.5.0_22/bin/javac \
      -DJAVA_RUNTIME:FILEPATH=/usr/java/jdk1.5.0_22/bin/java \
      -DJAVA_INCLUDE_PATH:PATH=/usr/java/jdk1.5.0_22/include \
      -DJAVA_INCLUDE_PATH2:PATH=/usr/java/jdk1.5.0_22/include/linux \
