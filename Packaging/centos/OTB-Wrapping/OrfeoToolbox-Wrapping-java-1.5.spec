...
cmake -DBUILD_TESTING:BOOL=OFF \
      ...
      -DJava_JAR_EXECUTABLE:FILEPATH=/usr/java/jdk1.5.0_22/bin/jar \
      -DJava_JAVAC_EXECUTABLE:FILEPATH=/usr/java/jdk1.5.0_22/bin/javac \
      -DJava_JAVA_EXECUTABLE:FILEPATH=/usr/java/jdk1.5.0_22/bin/java \
      -DJava_JAVAH_EXECUTABLE:FILEPATH=/usr/java/jdk1.5.0_22/bin/javah \
      -DJava_JAVADOC_EXECUTABLE:FILEPATH=/usr/java/jdk1.5.0_22/bin/javadoc \
...
* Wed Jul 06 2011 Sebastien Dinot <sebastien.dinot@c-s.fr> - 1.6.0-0+java5
- Packaging OTB Wrapping 1.6 for CentOS 5.5

* Mon May 06 2011 Sebastien Dinot <sebastien.dinot@c-s.fr> - 1.4.0-4+java5
- CentOS package build against Sun JDK 1.5.0-22
