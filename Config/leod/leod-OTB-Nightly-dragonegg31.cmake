...
SET (ENV{CC} "/opt/local/bin/dragonegg-3.1-gcc")
SET (ENV{CXX} "/opt/local/bin/dragonegg-3.1-g++")

SET (CTEST_SOURCE_DIRECTORY "/Users/otbval/WWW.ORFEO-TOOLBOX.ORG-CS-NIGHTLY/OTB")
SET (CTEST_BINARY_DIRECTORY "/Users/otbval/OTB-NIGHTLY-VALIDATION/build/OTB-dragonegg31")

SET( CTEST_CMAKE_GENERATOR  "Unix Makefiles" )
SET (CTEST_CMAKE_COMMAND "cmake" )
SET (CTEST_BUILD_COMMAND "/usr/bin/make -j8 -i -k" )
SET (CTEST_SITE "leod.c-s.fr")
SET (CTEST_BUILD_NAME "MacOSX10.5-Release-dragonegg31")
...
CMAKE_INSTALL_PREFIX:STRING=$ENV{HOME}/OTB-NIGHTLY-VALIDATION/install/OTB-dragonegg31
