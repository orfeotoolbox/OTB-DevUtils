...
set(CTEST_BUILD_NAME "MacOSX10.8-${CTEST_BUILD_CONFIGURATION}-gcc47")
...
set(dashboard_source_name "${lcdashboard_model}/OTB-${CTEST_BUILD_CONFIGURATION}-gcc47/src")
set(dashboard_binary_name "${lcdashboard_model}/OTB-${CTEST_BUILD_CONFIGURATION}-gcc47/build")
...
set(ENV{CC} "/opt/local/bin/gcc-mp-4.7")
set(ENV{CXX} "/opt/local/bin/g++-mp-4.7")
