...
set(dashboard_binary_name "otb/superbuild-stable")

set(CTEST_INSTALL_DIRECTORY ${CTEST_DASHBOARD_ROOT}/otb/install-sb-stable)
...
GDAL_SB_EXTRA_OPTIONS:STRING=/opt/rh/python27/root/usr/bin/python
")
endmacro()
