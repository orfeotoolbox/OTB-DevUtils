...
SET (CTEST_BINARY_DIRECTORY "C:/Users/jmalik/Dashboard/build/OTB-${CTEST_BUILD_CONFIGURATION}-VC2010")
...
CMAKE_INSTALL_PREFIX:PATH=C:/Users/jmalik/Dashboard/install/OTB-${CTEST_BUILD_CONFIGURATION}-VC2010
...
#remove install dir
execute_process(COMMAND ${CTEST_CMAKE_COMMAND} -E remove_directory C:/Users/jmalik/Dashboard/install/OTB-${CTEST_BUILD_CONFIGURATION}-VC2010)
execute_process(COMMAND ${CTEST_CMAKE_COMMAND} -E make_directory C:/Users/jmalik/Dashboard/install/OTB-${CTEST_BUILD_CONFIGURATION}-VC2010)
