...
ITK_DIR:PATH=${CTEST_DASHBOARD_ROOT}/build/ITKv4-RelDeb

SWIG_EXECUTABLE:FILEPATH=$ENV{OSGEO4W_ROOT}/apps/swigwin/swig.exe

PYTHON_EXECUTABLE:FILEPATH=$ENV{OSGEO4W_ROOT}/bin/python.exe
PYTHON_INCLUDE_DIR:PATH=$ENV{OSGEO4W_ROOT}/apps/Python27/include
PYTHON_LIBRARY:FILEPATH=$ENV{OSGEO4W_ROOT}/apps/Python27/libs/python27.lib
