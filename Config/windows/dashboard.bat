...
set BUILD_DIR_NAME=superbuild\%COMPILER_ARCH%
set INSTALL_DIR_NAME=install_sb\%COMPILER_ARCH%
set XDK_DIR_NAME=install_sb\%COMPILER_ARCH%
set OTB_BUILD_BIN_DIR=OTB\build\bin
) ELSE ( 
set LOG_FILE_NAME=OTB_win_%COMPILER_ARCH%_%dashboard_otb_branch%
set BUILD_DIR_NAME=build\%COMPILER_ARCH%
set INSTALL_DIR_NAME=install\%COMPILER_ARCH%
set XDK_DIR_NAME=xdk\%COMPILER_ARCH%\%XDK_FILE_NAME_WITHOUT_EXT%
