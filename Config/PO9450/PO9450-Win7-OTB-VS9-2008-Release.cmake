SET (CTEST_SOURCE_DIRECTORY "C:/Users/msavinau/dev/nightly/OTB-VS2008-Release/src")
SET (CTEST_BINARY_DIRECTORY "C:/Users/msavinau/dev/nightly/OTB-VS2008-Release/build")
...
CMAKE_INSTALL_PREFIX:PATH=C:/Users/msavinau/dev/nightly/OTB-VS2008-Release/install
...
#Remove install dir
execute_process(COMMAND ${CTEST_CMAKE_COMMAND} -E remove_directory C:/Users/msavinau/dev/nightly/OTB-VS2008-Release/install )
execute_process(COMMAND ${CTEST_CMAKE_COMMAND} -E make_directory C:/Users/msavinau/dev/nightly/OTB-VS2008-Release/install )
