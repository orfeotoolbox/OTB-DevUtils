...
set(CTEST_BUILD_NAME "MacOSX10.8-${CTEST_BUILD_CONFIGURATION}-gcc46")
...
set(dashboard_source_name "${lcdashboard_model}/OTB-${CTEST_BUILD_CONFIGURATION}-gcc46/src")
set(dashboard_binary_name "${lcdashboard_model}/OTB-${CTEST_BUILD_CONFIGURATION}-gcc46/build")
...
set(ENV{CC} "/opt/local/bin/gcc-mp-4.6")
set(ENV{CXX} "/opt/local/bin/g++-mp-4.6")
