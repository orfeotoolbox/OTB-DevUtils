...
set(CTEST_BUILD_NAME "OrfeoToolbox-Ubuntu-18.04_x86_64-${CTEST_BUILD_CONFIGURATION}_static")
...
set(dashboard_binary_name "build/ITK-${CTEST_ITK_VERSION}-${CTEST_BUILD_CONFIGURATION}_static")
...
CMAKE_INSTALL_PREFIX:PATH=$ENV{HOME}/dev/install/ITK-${CTEST_ITK_VERSION}-${CTEST_BUILD_CONFIGURATION}_static
